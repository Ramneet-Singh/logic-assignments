...
"""
def parseInput(formulaFileName : str) -> None:
...
fillProof.
"""
def parseProof(proofFileName : str) -> None:
...
def printProof(success:bool, proofFileName:bool) -> None:
